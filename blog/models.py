...
class User(User):
    ...
    QR_code = models.ImageField(upload_to='static/images/user_photo/%Y/%m', default='images/default.jpg',
                                max_length=100, verbose_name=u'微信二维码')
    photo = models.ImageField(upload_to='static/images/user_photo/%Y/%m', default='images/default.jpg',
...
class Post(models.Model):
    ...
    picture = models.ImageField(upload_to='static/images/post_img/%Y/%m', default='images/text02.jpg',
